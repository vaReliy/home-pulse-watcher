...
**Hardware**: 5V USB adapter -> 10k/10k voltage divider + 0.1µF cap -> ESP32-C3 GPIO (12-bit ADC, 0-4095). For non-standard input voltages, adjust R1/R2 per the voltage divider formula in the [Admin Guide](../admin-guide.md#voltage-divider-formula).
